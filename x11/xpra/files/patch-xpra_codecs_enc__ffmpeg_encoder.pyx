--- xpra/codecs/enc_ffmpeg/encoder.pyx.orig	2018-07-19 22:44:28 UTC
+++ xpra/codecs/enc_ffmpeg/encoder.pyx
@@ -132,46 +132,37 @@ cdef extern from "libavcodec/avcodec.h":
...
@@ -890,8 +871,8 @@ cdef class Encoder(object):
